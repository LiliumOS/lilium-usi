...
#define atomic_exchange_explicit(PTR, VAL, MO)				\
  ({									\
    ...
    __atomic_exchange ((__typeof__((void) 0, *__atomic_exchange_ptr)*)__atomic_exchange_ptr, &__atomic_exchange_val,	\
...
#define atomic_store_explicit(PTR, VAL, MO)				\
  ({									\
    ...
    __atomic_store ((__typeof__((void) 0, *__atomic_store_ptr)*)__atomic_store_ptr, &__atomic_store_tmp, (MO));	\
  })
